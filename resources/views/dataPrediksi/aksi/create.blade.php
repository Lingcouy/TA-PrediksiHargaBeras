                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control @error('tahun') is-invalid @enderror"
                                       name="tahun" id="tahunSelect" value="{{ old('tahun', date('Y')) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_bawah_i') is-invalid @enderror"
                                       id="harga_beras_kualitas_bawah_i" name="harga_beras_kualitas_bawah_i" value="{{ old('harga_beras_kualitas_bawah_i') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_bawah_ii') is-invalid @enderror"
                                       id="harga_beras_kualitas_bawah_ii" name="harga_beras_kualitas_bawah_ii" value="{{ old('harga_beras_kualitas_bawah_ii') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_medium_i') is-invalid @enderror"
                                       id="harga_beras_kualitas_medium_i" name="harga_beras_kualitas_medium_i" value="{{ old('harga_beras_kualitas_medium_i') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_medium_ii') is-invalid @enderror"
                                       id="harga_beras_kualitas_medium_ii" name="harga_beras_kualitas_medium_ii" value="{{ old('harga_beras_kualitas_medium_ii') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_super_i') is-invalid @enderror"
                                       id="harga_beras_kualitas_super_i" name="harga_beras_kualitas_super_i" value="{{ old('harga_beras_kualitas_super_i') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('harga_beras_kualitas_super_ii') is-invalid @enderror"
                                       id="harga_beras_kualitas_super_ii" name="harga_beras_kualitas_super_ii" value="{{ old('harga_beras_kualitas_super_ii') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('inflasi_bi') is-invalid @enderror"
                                       id="inflasi_bi" name="inflasi_bi" value="{{ old('inflasi_bi') }}">
                                @error('inflasi_bi')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('kurs_usd') is-invalid @enderror"
                                       id="kurs_usd" name="kurs_usd" value="{{ old('kurs_usd') }}">
                                @error('kurs_usd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('bbm_pertalite') is-invalid @enderror"
                                       id="bbm_pertalite" name="bbm_pertalite" value="{{ old('bbm_pertalite') }}">
                                @error('bbm_pertalite')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('ump_sulut') is-invalid @enderror"
                                       id="ump_sulut" name="ump_sulut" value="{{ old('ump_sulut') }}">
                                @error('ump_sulut')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control @error('pupuk_subsidi') is-invalid @enderror"
                                       id="pupuk_subsidi" name="pupuk_subsidi" value="{{ old('pupuk_subsidi') }}">
                                @error('pupuk_subsidi')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
