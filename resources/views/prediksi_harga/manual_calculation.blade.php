        ...
        <div class="container-fluid px-4">
            <div class="row my-3">
                ...
                <div class="table-responsive">
                    ...
                    <button onclick="exportComparisonTableToExcel()" class="btn btn-success mt-3">Export Tabel Perbandingan
                        ke Excel</button> {{-- Added button here --}}
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>(100%/{{ $mape_count > 0 ? $mape_count : 1 }}) ×
                                    {{ number_format($sum_mape_numerator, 4) }}</td>
                                <td>{{ $mape }}%</td>
                            </tr>
                        </tbody>
                    </table>
