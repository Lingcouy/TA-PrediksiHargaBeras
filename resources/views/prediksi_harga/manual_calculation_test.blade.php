    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <div class="d-flex align-items-center">
                ...
                <h2 class="fs-2 m-0">Perhitungan Manual (Data Uji) - Harga Beras Kualitas
        ...
        <div class="container-fluid px-4">
            <div class="row my-3">
                <a href="{{ route('data-beras.analyze') }}" class="btn btn-secondary mb-3">Kembali</a>
                <h4>Perhitungan Manual untuk Prediksi Harga Beras Kualitas
                    {{ str_replace('HARGA_BERAS_KUALITAS_', '', $category) }} (Data Uji)</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th>+</th>
                            <th title="Inflasi BI">b1X1</th>
                            <th>+</th>
                            <th title="Kurs USD">b2X2</th>
                            <th>+</th>
                            <th title="BBM Pertalite">b3X3</th>
                            <th>+</th>
                            <th title="UMP Sulut">b4X4</th>
                            <th>+</th>
                            <th title="Jumlah Penduduk">b5X5</th>
                            <th>+</th>
                            <th title="Pupuk Non-Subsidi">b6X6</th>
                            <th>=</th>
                            <th>Hasil (Y Predicted)</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach ($test_data_table as $index => $row)
                            <tr>
                                <td>{{ $row['NO'] }}</td>
                                <td>{{ $row['TANGGAL'] }}</td>
                    ...
                    <table class="table table-bordered table-striped" id="comparisonTable">
                        ...
                        @foreach ($test_data_table as $index => $row)
                            @php
                                ...
                                $predicted_price = (float) str_replace(',', '', $row['Y_PREDICTED']);
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>1/n ∑|yᵢ - ŷᵢ|</td>
                            <td>1/{{ count($test_data_table) }} × {{ number_format($sum_abs_diff, 2) }}</td>
                            <td>{{ $mae }}</td>
                        </tr>
                        <tr>
                            <td>RMSE (Root Mean Squared Error)</td>
                            <td>√((1/n) ∑(yᵢ - ŷᵢ)²)</td>
                            <td>√((1/{{ count($test_data_table) }}) × {{ number_format($sum_sq_diff, 2) }})</td>
                            <td>{{ $rmse }}</td>
                        </tr>
                        <tr>
